...
- コースは11本。日本6本（南北線・東西線・東豊線・山手線・札幌市電・阪急京都本線）と
  **海外5本**（ベルリン Ringbahn・ロンドン サークル線・モスクワ環状線・
  モスクワ大環状線・北京地下鉄10号線）。設定から切り替えられる。
  **山手線と市電は一周でき、内回り／外回りを選べる**（予定でも一周を決められる）
- コースは **国 → 都道府県 → 路線** の順にたどって選ぶ。**日本の外も入っている**（イギリス・ドイツ・ロシア・中国）。

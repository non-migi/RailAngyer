...
struct AttributionView: View {
            ...
            List {
                Section {
                    source(title: "国土数値情報（鉄道データ N02）",
                           holder: "国土交通省",
                           detail: "札幌市営地下鉄3路線と山手線の駅位置に使っています。"
                                 + "測地系は JGD2011。",
                ...
                Section {
                    ...
                    Text("ODbL では、このデータを使って作ったデータベースを配る場合、"
                         + "同じ条件で公開することが求められます。")
                }
                ...
                Section {
                    Text("駅の位置は公開データにもとづく参考値です。"
                         + "到着の判定、距離と時間の目安は、いずれも目安であり、"
                         + "実際の道のりや所要時間とは異なります。")
    ...
    @ViewBuilder
    private func source(title: String, holder: String, detail: String,

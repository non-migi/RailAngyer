...
struct ScheduleListView: View {
    ...
    ///
    /// **ここは「次の予定を始める」ための口**として残す。
    /// 歩いている最中に今日をやめるほうは「旅」の画面の「今日はここまでにする」で、
    /// 同じ結果になっても探すときに思い浮かべる言葉が違う
    private var currentJourneySection: some View {
        Section {
            ...
            Text("現在の旅は「記録」に保存され、次の予定を新しい旅として始められます。歩いている途中でやめるだけなら、「旅」の画面の「今日はここまでにする」からもできます。")
        }
    }
